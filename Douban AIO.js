...
:root {
  --drdm-bg: #fff;
  --drdm-text: #111;
  --drdm-aside-bg: #f4f4ec;
  --drdm-aside-color: #c65e24;
  --drdm-border: #eaeaea;
  --drdm-btn-bg: #242635;
  --drdm-btn-text: #37a;
  --drdm-btn-hover: #e8e8e8;
  --drdm-tag-exist-bg: #e3f1ed;
  --drdm-tag-exist-color: #3377aa;
  --drdm-tag-not-exist-bg: #f4eac2;
  --drdm-tag-not-exist-color: #3377aa;
  --drdm-tag-login-bg: #ddd;
  --drdm-tag-login-color: #3377aa;
  --drdm-tag-error-bg: #eee;
  --drdm-tag-error-color: #3377aa;
}
...
@media (prefers-color-scheme: dark) {
  :root {
    --drdm-bg: #181818;
    --drdm-text: #e0e0e0;
    --drdm-aside-bg: #2d2d2d;
    --drdm-aside-color: #d17b4d;
    --drdm-border: #333;
    --drdm-btn-bg: #2a2a2a;
    --drdm-btn-text: #66b3ff;
    --drdm-btn-hover: #3a3a3a;
    --drdm-tag-exist-bg: #2d4a43;
    --drdm-tag-exist-color: #88ccbb;
    --drdm-tag-not-exist-bg: #4a452d;
    --drdm-tag-not-exist-color: #cccba4;
    --drdm-tag-login-bg: #333;
    --drdm-tag-login-color: #bbb;
    --drdm-tag-error-bg: #3a3a3a;
    --drdm-tag-error-color: #aaa;
  }
  .top250-no { background: #c65e24 !important; color: #fff !important; }
  .top250-no:after { border-left-color: #c65e24 !important; }
  .top250-link { background: #2d2d2d !important; border-color: #c65e24 !important; }
  .top250-link a { color: #e0e0e0 !important; }
  .rank-label-no { background: #c65e24 !important; color: #fff !important; }
  .rank-label-no::before, .rank-label::before { background: none !important; }
  .rank-label-link { background: #2d2d2d !important; border: 1px solid #c65e24 !important; border-left: none !important; }
  .rank-label-link a { color: #e0e0e0 !important; }
}

html[data-darkreader-scheme="dark"] :root,
body.drdm-dark-mode :root {
    --drdm-bg: #181818;
    --drdm-text: #e0e0e0;
    --drdm-aside-bg: #2d2d2d;
    --drdm-aside-color: #d17b4d;
...
html[data-darkreader-scheme="dark"] .top250-no,
body.drdm-dark-mode .top250-no,
html[data-darkreader-scheme="dark"] .rank-label-no,
body.drdm-dark-mode .rank-label-no { background: #c65e24 !important; color: #fff !important; }

html[data-darkreader-scheme="dark"] .top250-no:after,
body.drdm-dark-mode .top250-no:after { border-left-color: #c65e24 !important; }

html[data-darkreader-scheme="dark"] .top250-link,
body.drdm-dark-mode .top250-link,
html[data-darkreader-scheme="dark"] .rank-label-link,
body.drdm-dark-mode .rank-label-link { background: #2d2d2d !important; border-color: #c65e24 !important; border-left: none !important; }

html[data-darkreader-scheme="dark"] .top250-link a,
body.drdm-dark-mode .top250-link a,
html[data-darkreader-scheme="dark"] .rank-label-link a,
body.drdm-dark-mode .rank-label-link a { color: #e0e0e0 !important; }

html[data-darkreader-scheme="dark"] .rank-label-no::before,
body.drdm-dark-mode .rank-label-no::before,
html[data-darkreader-scheme="dark"] .rank-label::before,
body.drdm-dark-mode .rank-label::before { background: none !important; }

#rank_toggle a { color: var(--drdm-btn-text); }
.rating_logo { color: var(--drdm-aside-color) !important; }
.rating_num { color: var(--drdm-text) !important; }
.rating_wrap { clear: both; padding: 10px 0; border-bottom: 1px solid var(--drdm-border); }
.rating_more div { display: flex; justify-content: space-between; align-items: center; margin-bottom: 4px; font-size: 13px; }
.rating_more a { position: static !important; margin-left: auto; text-align: right; white-space: nowrap; }
.c-aside-body a{border-radius:6px;display:inline-block;letter-spacing:normal;margin:0 8px 8px 0;padding:0 8px;text-align:center;width:65px}
.c-aside-body a:link,.c-aside-body a:visited{background-color:var(--drdm-btn-bg);color:var(--drdm-btn-text)}
.c-aside-body a:active,.c-aside-body a:hover{background-color:var(--drdm-btn-hover);color:var(--drdm-btn-text)}
.c-aside-body a.sites_r0{text-decoration:line-through}

#drdm_req_status { color: var(--drdm-aside-color); background: var(--drdm-aside-bg); padding: 10px; margin-bottom: 20px; word-wrap: break-word; border-radius: 4px; border: 1px solid var(--drdm-border); }

.drdm-tag-exist { background-color: var(--drdm-tag-exist-bg) !important; color: var(--drdm-tag-exist-color) !important; }
.drdm-tag-not-exist { background-color: var(--drdm-tag-not-exist-bg) !important; color: var(--drdm-tag-not-exist-color) !important; }
.drdm-tag-need-login { background-color: var(--drdm-tag-login-bg) !important; color: var(--drdm-tag-login-color) !important; }
.drdm-tag-error { background-color: var(--drdm-tag-error-bg) !important; color: var(--drdm-tag-error-color) !important; }

#c_dialog li{margin:10px}#c_dialog{text-align:center}
#interest_sectl .rating_imdb{border-top:1px solid var(--drdm-border);border-bottom:1px solid var(--drdm-border);padding-bottom:0}
#interest_sectl .rating_wrap{padding-top:15px}
#interest_sectl .rating_more{border-bottom:1px solid var(--drdm-border);color:var(--drdm-text);margin:0;padding:15px 0;position:relative}

.more{display:block;height:34px;line-height:34px;text-align:center;font-size:14px;background:var(--drdm-aside-bg);color:var(--drdm-text)}

div#drdm_setting input[type=checkbox]{display:none}
div#drdm_setting input[type=checkbox]+label{display:inline-block;width:40px;height:20px;position:relative;transition:.3s;margin:0 20px;box-sizing:border-box;background:var(--drdm-border);border-radius:20px;box-shadow:inset 1px 1px 3px rgba(0,0,0,0.1)}
div#drdm_setting input[type=checkbox]+label:after,div#drdm_setting input[type=checkbox]+label:before{content:'';display:block;position:absolute;left:0;top:0;width:20px;height:20px;transition:.3s;cursor:pointer}
div#drdm_setting input[type=checkbox]+label:after{background:#fff;border-radius:50%;box-shadow:1px 1px 3px rgba(0,0,0,0.2)}
div#drdm_setting input[type=checkbox]:checked+label{background:#aedcae}
div#drdm_setting input[type=checkbox]:checked+label:after{background:#5cb85c;left:calc(100% - 20px)}
...
#drdm_doulist, #drdm_setting { background: var(--drdm-bg); color: var(--drdm-text); padding: 20px; border-radius: 8px; }
`);
    ...
    function executeFetch() {
        GM_xmlhttpRequest({
            ...
            headers: {
                ...
                "Referer": (url.includes('imdb.com') ? 'https://www.imdb.com/' : 'https://www.google.com/'),
                "Accept-Language": "en-US,en;q=0.9,zh-CN;q=0.8,zh;q=0.7",
                "Cache-Control": "no-cache"
            },
            timeout: 10000,
            onload: function (responseDetail) {
                // 如果是 202 且还有重试次数，则等一下再试 (IMDb 常见 CDN 状态)
                if (responseDetail.status === 202 && retryCount < maxRetries) {
                    retryCount++;
                    setTimeout(executeFetch, 1500); // 1.5秒后重试
                    return;
                }
                ...
                if (responseDetail.status === 200) {
                    ...
                    console.error("Fetch failed for " + url + ", status: " + responseDetail.status);
                    if (typeof callback === 'function') {
                        try { callback(null, responseDetail, meta); } catch (e) {}
                    }
                }
            },
            onerror: function(err) {
                ...
                if (typeof callback === 'function') {
                    try { callback(null, err, meta); } catch (e) {}
                }
            },
            ontimeout: function() {
                console.warn("Fetch timeout for " + url);
                if (typeof callback === 'function') {
                    try { callback(null, null, meta); } catch (e) {}
                }
            }
        });
    }
...
if (typeof GM_registerMenuCommand !== "undefined") {
    ...
    function toggleDarkMode() {
        let current = GM_getValue("force_dark_mode", false);
        GM_setValue("force_dark_mode", !current);
        location.reload();
    }
    GM_registerMenuCommand("强制深色模式切换", toggleDarkMode);
}
...
$(document).ready(function () {
    ...
    let isDark = window.matchMedia('(prefers-color-scheme: dark)').matches ||
                 ...
                 GM_getValue("force_dark_mode", false);

    if (isDark) {
        $('body').addClass('drdm-dark-mode');
    }

    // 注入用户自定义的颜色变量，仅在非默认情况下生效，或按需适配
    let tag_exist_bg = GM_getValue("tag_bcolor_exist", "#e3f1ed");
    let tag_not_exist_bg = GM_getValue("tag_bcolor_not_exist", "#f4eac2");

    // 如果用户修改了默认颜色，我们应用它，但在深色模式下如果还是“默认颜色”则不注入，让全局深色变量生效
    let custom_css = ":root {";
    if (tag_exist_bg !== "#e3f1ed" || !isDark) custom_css += `--drdm-tag-exist-bg: ${tag_exist_bg};`;
    if (tag_not_exist_bg !== "#f4eac2" || !isDark) custom_css += `--drdm-tag-not-exist-bg: ${tag_not_exist_bg};`;

    // Fg 颜色同理
    let tag_exist_fg = GM_getValue("tag_fcolor_exist", "#3377aa");
    if (tag_exist_fg !== "#3377aa" || !isDark) custom_css += `--drdm-tag-exist-color: ${tag_exist_fg};`;
    ...
    if (douban_id) {
        ...
        $("#content div.aside").prepend(`<div id="drdm_req_status" style="display: none;">
...
<div class="rating_wrap clearbox rating_anidb" style="border-top: 1px solid #eaeaea; display:none"></div>`); // 修复部分情况$("div.rating_betterthan")不存在情况
            ...
            if (has_imdb) {
                ...
                // OMDb API 剧集 ID 修正
                let enable_omdb_api = GM_getValue('enable_omdb_api', false);
                let apikey_omdb = GM_getValue('apikey_omdb', '');
                if (is_series && enable_omdb_api && apikey_omdb) {
                    try {
                        let omdb_res = await new Promise((resolve, reject) => {
                            GM_xmlhttpRequest({
                                method: 'GET',
                                url: `https://www.omdbapi.com/?apikey=${apikey_omdb}&i=${imdb_id}`,
                                timeout: 10000,
                                onload: resolve,
                                onerror: reject,
                                ontimeout: reject
                        ...
                        let omdb_json = JSON.parse(omdb_res.responseText);
                        if (omdb_json.Type === 'episode' && omdb_json.seriesID) {
                            imdb_id = omdb_json.seriesID;
                            console.log('OMDb: IMDb ID override with series ID', imdb_id);
                        }
                    } catch (e) {
                        console.error("OMDb API 获取剧集 ID 失败", e);
                    }
                }
                ...
                getDoc(imdb_link, null, function (doc) {
                    ...
                    try {
                        ...
                        if (!mdblist_ratings.metacritic && GM_getValue("enable_metacritic_rate", true)) {
                            ...
                            getDoc(critic_link, null, function (critdoc) {
                                if (!critdoc) {
                                    $('#interest_sectl div.rating_meta').html(`<span class="rating_logo ll">Metacritic评分</span><br><div class="rating_self clearfix"><a target='_blank' href='https://www.metacritic.com/search/${encodeURIComponent(ywm.trim())}/'>搜索 metacritic</a></div>`).show();
                                    return;
                                }
                                try {
                                    let critJsonStr = $('script#__NEXT_DATA__', critdoc).text();
                                    let critJson = JSON.parse(critJsonStr);
                                    let metaData = critJson.props.pageProps.contentData.data.title.metacritic;
                                    
                                    if (metaData && metaData.metascore) {
                                        let metascore = metaData.metascore.score;
                                        let reviewCount = metaData.metascore.reviewCount || 0;
                                        let metaDesc = metaData.metascore.description || "";
                                        // 使用 Metacritic 官方配色
                                        let mColor = metascore >= 61 ? '#00ce7a' : (metascore >= 40 ? '#ffbd3f' : '#ff0000');
                                    ...
                                    console.error("Metascore parse error", e);
                                    $('#interest_sectl div.rating_meta').html(`<span class="rating_logo ll">Metacritic评分</span><br><div class="rating_self clearfix"><a target='_blank' href='https://www.metacritic.com/search/${encodeURIComponent(ywm.trim())}/'>搜索 metacritic</a></div>`).show();
                                }
                            });
                        }
                        ...
                        console.error("IMDb parsing error:", e);
                        $('#loading_more_rate').hide();
                    };
                    ...
                    if (!mdblist_ratings.tomatoes && GM_getValue("enable_tomato_rate", true)) { //烂番茄评分显示功能
                        ...
                        getDoc(rottURL, null, function (rotdoc) {
                            ...
                            let score_json_sel = $('#score-details-json, #media-scorecard-json', rotdoc);
                            if (score_json_sel.length > 0) {
                                try {
                                    let rottJson = JSON.parse(score_json_sel.text());
                                    let rating_rott_value, fresh_rott_value, rotten_rott_value;

                                    if (rottJson.modal && rottJson.modal.tomatometerScoreAll) { // 兼容旧结构
                                        let tomatometerScoreAll = rottJson.modal.tomatometerScoreAll || {};
                                        rating_rott_value = tomatometerScoreAll.score || 0;
                                        fresh_rott_value = tomatometerScoreAll.likedCount || 0;
                                        rotten_rott_value = tomatometerScoreAll.notLikedCount || 0;
                                    } else if (rottJson.criticsScore) { // 新结构
                                        rating_rott_value = rottJson.criticsScore.score || 0;
                                        fresh_rott_value = (rottJson.criticsScore.reviewCount * (rating_rott_value / 100)) || 0; // 估算
                                        rotten_rott_value = rottJson.criticsScore.reviewCount - fresh_rott_value;
                                    }

                                    if (rating_rott_value !== undefined) {
                                        $('#interest_sectl .rating_rott #rottValue').append(`<strong class="ll rating_num"><a target="_blank" href="${rottURL}">${rating_rott_value}%</a></strong><div class="rating_right" style="line-height: 16px;"><span>鲜:&nbsp;&nbsp;${Math.round(fresh_rott_value)}</span><br><span>烂:&nbsp;&nbsp;${Math.round(rotten_rott_value)}</span></div>`);
                                    }
                                } catch(e) { console.error("RT JSON parse error", e); }
                            }
                            else {
                                $('#interest_sectl div.rating_rott').append(`<br><a target='_blank' href='https://www.rottentomatoes.com/search/?search=${encodeURIComponent(ywm.trim())}'>搜索 rotta</a>`);
                            }
                        });
                    }
                    $("#loading_more_rate").hide();
            ...
            let series_exact = imdb_id;
            if (is_series) {
                series_exact = eng_title;
            }

            if (GM_getValue("enable_blue_date", true)) { //蓝光发售日期显示功能
                let ywm = eng_title.replace(/[:,!\-\.]/g, "").trim().replace(/\s+/g, '-').replace(/-+/g, '-').replace(/^-|-$/g, '');
                let blueURL = 'https://www.releases.com/p/' + ywm.toLowerCase();
                getDoc(blueURL, null, function (bluedoc) {
                    let release_info = [];
                    $('.RWP-Product-ReleaseInfoView-DateListItem', bluedoc).each(function() {
                        let type = $(this).find('.RWP-Product-ReleaseInfoView-Item').text().trim();
                        let dateStr = $(this).find('.RWP-Product-ReleaseInfoView-ItemReleaseDate').text().trim();
                        if (dateStr && !/TBA/i.test(dateStr)) {
                            release_info.push({ type, dateStr });
                        }
                    });

                    if (release_info.length > 0) {
                        release_info.forEach(item => {
                            if (!/VOD|Blu-ray/i.test(item.type)) return; // 仅显示 VOD 和 蓝光
                            let blueDate = new Date(item.dateStr);
                            if (!isNaN(blueDate.getTime())) {
                                let name = item.type.replace(/Blu-ray/i, '蓝光');
                                update_rating_more({
                                    name: name + '发售',
                                    link: blueURL,
                                    data: blueDate.toISOString().split('T')[0] // 格式化为 YYYY-MM-DD
                                });
                            }
                        });
                    } else {
                        // Fallback to legacy parsing if new structure not found
            ...
            if (!(is_mandarine) || (is_mandarine && is_otherlan)) {
                site_map.push({
                    ...
                    label: [
                        ...
                        { name: 'OpenSub', link: 'https://www.opensubtitles.org/zh/search/sublanguageid-all/imdbid-' + imdb_id, selector: "#search_results tr.change", selector_need_login: "#recaptcha2" },
                    ]
                });
            }
            ...
            let temp;
            if (is_movie) temp = 'movie';
            if (is_series) temp = 'show';
            if (has_imdb) {
                site_map.push({
                    name: "🍕🍔🍟🌭🍿🧂🍳🧀🥞",
                    label: [
                        //{ name: 'TGx', link: 'https://torrentgalaxy.to/torrents.php?search=' + /*series_exact*/imdb_id + '&sort=size&order=desc', selector: '#click' },
                        { name: 'BtDig', link: 'https://www.btdig.com/search?q=' + ywm, selector: 'table.table2 div.tt-name' },
                        { name: 'DMM', link: 'https://debridmediamanager.com/'+ temp + '/' + imdb_id, selector: 'table.table2 div.tt-name' },
                        { name: 'TorrentLeech', link: 'https://www.tlgetin.cc/torrents/browse/index/imdbID/' + /*series_exact*/imdb_id + '/orderby/size/order/desc', selector: 'table.table2 div.tt-name' },
                        ...
                        { name: 'TheRarbg', link: 'https://therarbg.com/get-posts/order:-s:keywords:' + /*series_exact*/imdb_id, selector: 'table.table2 div.tt-name' },
                        { name: 'Milkie', link: 'https://milkie.cc/browse?query=' + ywm + '&categories=1&categories=2', selector: 'table.table2 div.tt-name' },
                        { name: 'MovieboxPro', link: 'https://www.movieboxpro.app/index/search?word=' + /*series_exact*/imdb_id, selector: '#click' },
                        { name: 'Ext', link: 'https://ext.to/browse/?sort=size&order=desc&imdb_id=' + imdb_id, selector: 'table.table.table-striped.table-bordered.table-hover.table-condensed td.td' },
                        { name: 'Knaben', link: 'https://knaben.eu/search/' + ywm.replace(/S\d+$/g, ''), selector: 'table.table.table-striped.table-bordered.table-hover.table-condensed td.td' },
                        { name: 'Rutracker', link: 'http://rutracker.org/forum/search_cse.php?q=' + ywm, ajax: `https://www.google.com/search?q=allintitle:+${ywm}+site:rutracker.org`, selector: `a > h3:contains(${eng_title})` },
                        ...
                        { name: 'Bt4g', link: 'https://bt4gprx.com/search?q=' + ywm, selector: 'table.table2 div.tt-name' },
                        { name: 'Nyaa', link: 'https://nyaa.si/?q=' + eng_title, selector: 'div.table-responsive tr.default' },
                        { name: '动漫花园', link: 'https://share.dmhy.org/topics/list?keyword=' + unititle, selector: 'tbody span.btl_1' },
                        ...
                        { name: 'EZTV', link: 'https://eztv.ag/search/' + ywm.replace(/S\d+$/g, ''), selector: `td.forum_thread_post > a[title*='${ywm.replace(/S\d+$/g, '')}']` },
                        { name: 'PianYuan', link: 'http://pianyuan.org/search?q=' + dbzw, selector: 'div.row ul.detail' },
                    ]
                });
            }

            // 在页面中添加按钮的 HTML
            const buttonHtml = `<button id="openLinksButton">All in One</button>`;
            $('#drdm_sites').prepend(buttonHtml); // 假设你想把按钮放在这个元素前面

            // 添加点击事件
            $('#openLinksButton').on('click', function () {
                const tgxLink = 'https://torrentgalaxy.to/torrents.php?search='+ /*series_exact*/imdb_id;
                const btdigLink = 'https://www.btdig.com/search?q=' + ywm;
                const dmmLink = 'https://debridmediamanager.com/'+ temp + '/' + imdb_id;
                const tlLink = 'https://www.tlgetin.cc/torrents/browse/index/imdbID/' + /*series_exact*/imdb_id + '/orderby/size/order/desc';
                const rbLink = 'https://therarbg.com/get-posts/order:-s:keywords:' + /*series_exact*/imdb_id;
                const milkieLink = 'https://milkie.cc/browse?query=' + ywm + '&categories=1&categories=2';

                // 同时打开多个链接
                window.open(tgxLink, '_blank');
                window.open(btdigLink, '_blank');
                window.open(dmmLink, '_blank');
                window.open(tlLink, '_blank');
                window.open(rbLink, '_blank');
                window.open(milkieLink, '_blank');
            });
            ...
            if (has_imdb) {
                site_map.push({
                    name: "🕵️🥷🧑‍🏭🧑‍💻🧑‍🎨👩‍🚀🧙🧛‍♀️🦹‍♂️",
                    label: [
                        { name: '字幕库', link: 'https://zmk.pw/search?q=' + imdb_id, selector: "h3 a" },
                        { name: 'Sub HD', link: 'https://subhd.tv/search/' + series_exact, selector: ".position-relative .float-start" },
                        { name: 'r3sub', link: 'https://r3sub.com/search.php?s=' + dbzw, selector: "div.col-sm-8.col-md-9.col-lg-8 div.movie.movie--preview.ddd" },
                        { name: 'OpenSub', link: 'https://www.opensubtitles.org/zh/search/sublanguageid-all/imdbid-' + imdb_id, selector: "#search_results tr.change", selector_need_login: "#recaptcha2" },
            ...
            site_map.push({
                ...
                label: [
                    ...
                    { name: '秒搜', link: 'https://miaosou.fun/info?searchKey=' + unititle, selector: `.filetext p.fname:contains(${unititle})` },
                    { name: '盘友圈', link: 'https://panyq.com', selector: `.filetext p.fname:contains(${unititle})` },
                    ...
                    { name: 'Pan58电影', link: 'http://www.pan58.com/s?wd=' + unititle + '&s=2&t=0&p=1', selector: `.filetext p.fname:contains(${unititle})` },
                    { name: '毕方铺', link: 'https://www.iizhi.cn/resource/search/' + unititle, selector: '.main-info h1' },
                ]
            });
        ...
        function Exist_check(label) {
            ...
            function TagExist(link) {
                $(psite).removeClass("drdm-tag-not-exist drdm-tag-need-login drdm-tag-error").addClass("drdm-tag-exist").attr("title", "资源存在");
            ...
            function TagNotExist() {
                $(psite).removeClass("drdm-tag-exist drdm-tag-need-login drdm-tag-error").addClass("drdm-tag-not-exist").attr("title", "资源不存在");
                HideTag();
            }

            function TagNeedLogin() {
                $(psite).removeClass("drdm-tag-exist drdm-tag-not-exist drdm-tag-error").addClass("drdm-tag-need-login");
            ...
            function TagError(errtype) {
                $(psite).removeClass("drdm-tag-exist drdm-tag-not-exist drdm-tag-need-login").addClass("drdm-tag-error");
